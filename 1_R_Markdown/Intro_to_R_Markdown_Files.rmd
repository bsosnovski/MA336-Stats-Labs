...
2. How to use most commonly R Markdown syntax
...
As you see in the beginning of this lab, you can embed an R code chunk like this:
...
Note that the line preceeded by `#` is a comment in the R code, and that you can add comments in the R code chunk with a pound sign. 


### Example

Enter a R code chunck that produce as a result the number 6.

`Enter your code below:`



To add an inline code use a pair of single backticks and the letter r. For example, `r 2*3` (compare this with the Rmd file). We can also mark text as inline code by using just the pair of backticks. For example, `code`.
