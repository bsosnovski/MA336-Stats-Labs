...
All that means is that we need to adjust the code to specify the path to the newly created library directory and the type of file being installed.
...
Next time you install another package in the `Home` directory of your project, you will not need to create the library because it has already been created (SKIP steps 8 and 9). 
