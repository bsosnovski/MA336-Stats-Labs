...
Next time you install another package in the `Home` directory of your project, you will not need to create the library because it has already been created (you will NOT run steps 5 and 6). 
